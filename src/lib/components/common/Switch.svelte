<script>
	...
	import { defaultTheme } from '$lib/stores';

    export let label;
    export let design = 'inner label'
    export let options = [];
    export let fontSize = 16;
    export let value = defaultTheme;

    let checked = (value == 'accenture-dark') || (localStorage.theme == 'accenture-dark');
    ...
    function handleClick(event){
        ...
        value = checked === true ? 'accenture-dark' : 'accenture-light'
    }
...
<div class="s s--inner">
    ...
    <button
        ...
        aria-labelledby={`switch-$w{uniqueID}`}
