<script lang="ts">
	...
	import { user, chats, settings, showSettings, chatId, tags, theme } from '$lib/stores';
...
>
	...
	>
		...
		<div class="flex items-center w-full max-w-full">
			<div class="pr-2 self-start acn-theme-switch">
				...
				<div>
					<Switch bind:value={themeUsed} label="" fontSize={12} design="slider" />
				</div>
